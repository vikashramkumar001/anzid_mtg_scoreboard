...
// Generate all 16 standing rows (for ranks 17-32)
...
socket.on('broadcast-round-standings-data', (data) => {
    console.log('standings data (17-32)', data);
    standingsData = data;

    // Update all 16 rows (ranks 17-32)
    for (let i = 1; i <= TOTAL_STANDINGS; i++) {
        const dataRank = START_RANK + i - 1; // Maps 1-16 to 17-32
